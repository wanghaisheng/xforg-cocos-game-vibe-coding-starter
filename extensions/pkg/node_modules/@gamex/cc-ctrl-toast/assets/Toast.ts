import { _decorator, Component, instantiate, NodePool, Prefab, Tween, tween, UIOpacity, UITransform, view } from 'cc';
import ToastCell from './native/ToastCell';
...
export default class Toast extends Component {
    ...
    add(data: {
        ...
        cell.getComponent(ToastCell).init(data.message);
